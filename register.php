...
<body class="layout- layout-sticky-subnav ">
        ...
        <div class=" pt-32pt pt-sm-64pt pb-32pt">
            ...
            <div class="container-fluid page__container">
                ...
                <div class="justify-content-center mt-0" >
                   <a href="http://localhost:8012/erp">
                ...
                <div class="card" style="padding: 20px">
                    ...
                    <form action="http://localhost:8012/erp" class="col-md-5 p-0 mx-auto">
                        <div class="form-group">
                            <label class="form-label" for="email">Institution Name:</label>
                            <input id="name" type="text" class="form-control" placeholder="Your email address ...">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="email">Email:</label>
                            <input id="email" type="email" class="form-control" placeholder="Your first and last name ...">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="password">Access Level:</label>
                            <input id="password" type="text" class="form-control" placeholder="Your first and last name ...">

                        </div>

                        <div class="form-group">
                            <button class="btn btn-lg btn-accent form-control text-center">Register</button>
                        </div>
                    </form>
